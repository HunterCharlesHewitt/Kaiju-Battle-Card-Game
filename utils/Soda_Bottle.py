class Soda_Bottle(Creature):
    ...
    def sp(target_user_id):
        ...
        return [
            ['action_response',{'heal_health_modifier': 0,'damage_health_modifier': -7, 'acting_user':self.user_id, 'action':'Soda Bottle: Unscrew Lid'},target_user_id],
            ['soda_bottle_sp_fizz_response',{'fizz_points': -2, 'acting_user':self.user_id, 'action':'Soda Bottle: Unscrew Lid'},"broadcast"]
        ]