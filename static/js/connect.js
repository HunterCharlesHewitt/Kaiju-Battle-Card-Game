...
leave_room_global = function(msg,cb) {
    ...
    $('#'+socket.username_to_character[msg['username']]).removeAttr('disabled')
    $('#'+socket.username_to_character[msg['username']]).css('background','radial-gradient(circle, #8b0000, #8b0000)')
